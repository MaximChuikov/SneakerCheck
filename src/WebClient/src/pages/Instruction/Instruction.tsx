...
import {getInstruction} from "../../api/InstructionService";
        ...
        : (
          <>
            ...
            <Card>
              <Row>
                <Col span={2}>
                  <Image src={instr?.shop.iconLink ?? ''} width={45} style={{borderRadius: '4px'}} />
                </Col>
                <Col span={22}>
                  <Typography.Title style={{margin: '0'}} level={3}>{instr?.shop.shopName}</Typography.Title>
                </Col>
              </Row>

              <Row style={{margin: '12px 0'}}>
                <Col>
                  <Badge count={instr?.likes} offset={[19, 18]} overflowCount={9999} style={{backgroundColor: '#28C98E', color: '#4b4e56', fontWeight: 'bold' }}>
                    <Avatar shape={'square'} size={'large'} src={<LikeFilled />} />
                  </Badge>
                </Col>
                <Col offset={2}>
                  <Badge count={instr?.dislikes} offset={[19, 18]} overflowCount={9999} style={{backgroundColor: '#ED522F', color: '#37393f', fontWeight: 'bold'}}>
