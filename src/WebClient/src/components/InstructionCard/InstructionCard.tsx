  ...
  return (
    <a href={RouteNames.INSTRUCTIONS + '/' + content.instructionId}>
      <Card>
        <Row>
          <Col span={2}>
            <Image preview={false} src={content.shop.iconLink} width={45} style={{ borderRadius: '4px' }} />
          </Col>
          <Col span={22}>
            <Typography.Title style={{ margin: '0' }} level={3}>{content.shop.shopName}</Typography.Title>
          </Col>
        </Row>
        ...
        <Row>
          <Col>
            <Badge count={content.likes} offset={[19, 18]} overflowCount={9999} style={{backgroundColor: '#28C98E', color: '#4b4e56', fontWeight: 'bold' }}>
